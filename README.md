...
### **"DFT_training_data.tar.gz"** file
Unzip the file by
```
tar -zxvf DFT_training_data.tar.gz
```
Then "DFT_training_data" directory will be created. This directory contains training data generated by DFT.

### **"AX_BX2_References.tar.gz"** file
Unzip the file by
```
tar -zxvf AX_BX2_References.tar.gz
```
Then "AX_BX2_reference" directory will be created. This directory contains DFT calculations results for reference materials for decomposition energy calculation.
...
### **"DFT_validation_for_selected_compositions.tar.gz"** file
Unzip the file by
```
tar -zxvf DFT_validation_for_selected_compositions.tar.gz
```
Then "DFT_validation_for_selected_compositions" directory will be crated. This directory contains DFT calculation results for selected composition from CGCNN searching. See the paper for criteria of selection.
